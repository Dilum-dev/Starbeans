...
<head>
  ...
  <style>
    :root {
      --primary: #8b2b2bff;
      --primary-dark: #6d2222ff;
      --primary-light: #a65252ff;
      --light: #ffefefff;
      --dark: #2a2a2a;
      --text: #4a4a4a;
  ...
  <script>
    document.getElementById('contactForm').addEventListener('submit', function(e) {
      ...
      if (isValid) {
        ...
        Promise.all([
            fetch('../email_processes/take/contactTakeProcessAdmin.php', {
              method: 'POST',
              body: formData1
            }).then(parseResponse),
            fetch('../email_processes/take/contactTakeProcessUser.php', {
              method: 'POST',
              body: formData2
            }).then(parseResponse)
          ])
