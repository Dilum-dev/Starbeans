...
<head>
  ...
  <style>
    :root {
      --primary: #2b8b40ff;
      --primary-dark: #226d3fff;
      --primary-light: #52a660ff;
      --light: #f4ffefff;
      --dark: #2a2a2a;
      --text: #4a4a4a;
    ...
    <div class="section-wrapper">
      <div class="contact-grid">
        ...
        <div class="contact-info">
          <img src="../assets/images/barn_vibe.webp" alt="Contact Starbeans" class="contact-image">
        </div>
  ...
  <script>
    document.getElementById('contactForm').addEventListener('submit', function(e) {
      ...
      if (isValid) {
        ...
        Promise.all([
            fetch('../email_processes/barn/contactBarnProcessAdmin.php', {
              method: 'POST',
              body: formData1
            }).then(parseResponse),
            fetch('../email_processes/barn/contactBarnProcessUser.php', {
              method: 'POST',
              body: formData2
            }).then(parseResponse)
          ])
