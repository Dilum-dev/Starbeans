...
<body>
    <div class="grid_top_section">
        <h1 class="grid_title">Savor Every Moment with Starbeans</h1>
        <p class="grid_sub">Explore our photos to see what Ocean Bistro is all about. From tasty meals to cozy restaurant spaces, each picture shows the care and quality we put into everything – from the food we serve to the places we create for you to enjoy.</p>
    </div>
